...
Where: Master = where Jenkins is installed, Slave1 = Test environment, Slave2 = Production environment  
2. Jenkins Master-Slave cluster setup on AWS
3. CI/CD pipeline triggered by webhook
4. Git commit -> Test Environment -> Production Environment
